...
const Service = ({ service }) => {
    ...
    return (
        <div className="max-w-sm mx-10 md:mx-auto  transition ease-in-out delay-100 overflow-hidden hover:drop-shadow-2xl hover:-translate-y-1  duration-500 hover:scale-110  bg-white rounded-lg shadow-lg dark:bg-gray-800">
            <img
